...
<template>
	...
	<el-row>
	    ...
	    <el-col :span="3">
	        <el-button @click="searchClick()" size="small">查询部门2</el-button>
	    </el-col>
	    <el-col :span="3">
	        <el-button @click="openInsertDialog()" size="small">新增部门2</el-button><br/>
	    </el-col>
		<el-col :span="3">
		...
		<el-table-column label="编辑" width="280">
			<template #default="scope">
				...
				<div style="background-color: transparent">
					...
					<el-button size="small" @click="" type="primary" v-if="scope.row.locid==21">
						投标
					</el-button>
					<el-button size="small" @click="" type="primary" v-if="scope.row.locid==28">
						发货
					</el-button>
				</div>
			</template>
	...
	<!--以下为新增-->
	<!--修改部门抽屉 开始-->
	<el-drawer v-model="updateVisible" title="I am the title" :with-header="false" >
	   <el-form>
	   	<el-row>
	   		<el-form-item label="部门编码" >
